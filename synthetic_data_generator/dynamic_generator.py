...
class DynamicGenerator:
    """
    A dynamic, AI-powered synthetic data generator that can be extended with custom patterns.
    """
    def __init__(self, custom_patterns=None):
        self.parser = AIParser(custom_patterns=custom_patterns)
    ...
    def generate(self, prompt, num_rows):
        ...
        if not specifications:
            raise ValueError("Could not parse the prompt to generate a file specification. Please be more descriptive or provide custom patterns.")
